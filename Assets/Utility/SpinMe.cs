...
public class SpinMe : MonoBehaviour {
	...
	void Update () {
        ...
        // degress frame^-1 = seconds frame^-1, seconds minute^-1, degress rotation^-1, rotation minute^-1
        // degress frame^-1 = seconds frame^-1 / seconds minute^-1, degress rotation^-1 * rotation minute^-1
        // degress frame^-1 = frame^-1 minute * degress rotation^-1 * rotation minute^-1
